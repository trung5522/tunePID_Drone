...
//	HAL_UART_Transmit(&huart6, agcal, strlen((char *)agcal), 0xFFFF);
	HAL_Delay(5000);
...
//	HAL_UART_Transmit(&huart6, agcal1, strlen((char *)agcal1), 0xFFFF);
	HAL_Delay(5000);
...
//		HAL_UART_Transmit(&huart6, mag_cal, strlen((char *)mag_cal), 0xFFFF);;
	        HAL_Delay(4000);
